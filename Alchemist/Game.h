...
const int LIST_ELEMENTS = -1; //constant to list elements
const int MIN_ELEMENTS = 0; //constant for smallest element index
const int MENU_DISPLAY = 1; //display elements menu option
const int MENU_COMBINE = 2; //combine elements menu option
const int MENU_SCORE = 3; //display score menu option
const int MENU_QUIT = 4; //quit menu option
const int NO_ELEMENT = -1; //returned when elements cannot be combined

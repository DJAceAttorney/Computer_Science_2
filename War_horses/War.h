...
const int ENEMY_HORSES = 48; //Number of enemy horses
const int DISPLAY_HORSES = 1; //Display horses
const int DISPLAY_ENEMY = 2; //Display enemy horses
const int ACQUIRE_HORSE = 3; //User acquires horse
const int TRAIN_HORSE = 4; //User trains horse
const int START_BATTLE = 5; //User battles horses
